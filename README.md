...
4. Lunch [Jupyter Notebook](https://jupyter.org/) with `jupyter notebook --NotebookApp.iopub_data_rate_limit=10000000`
...
2. Lunch [Jupyter Notebook](https://jupyter.org/) with `jupyter notebook --NotebookApp.iopub_data_rate_limit=10000000`
